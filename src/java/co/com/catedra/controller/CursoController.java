...
import co.com.catedra.operaciones.CursoFacade;
...
public class CursoController implements Serializable {
    ...
    private DataModel items = null;
     ...
     @EJB
    private co.com.catedra.operaciones.AsignaturaFacade af;
    
    //////////
    
    @EJB
    private co.com.catedra.operaciones.CursoFacade ejbFacade;
    ...
    //////////////
      ...
      public void obtenerIdCursoProfesor() {
          ...
          lista = af.buscarMisAsignaturasProfesorCurso(luc.getUsuario(), current);
    }
    ...
    public SelectItem[] getItemsAvailableSelectOne() {
      ...
      public List<Curso> getItemsAvailableSelectOneMisCursos() {
          if (luc.getProfesor()!=null) {
              
          return ejbFacade.buscarMisCursos(luc.getProfesor());
          }
          return null;
    }
